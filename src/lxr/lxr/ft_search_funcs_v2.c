...
/*   Updated: 2023/04/26 10:25:46 by alvjimen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "lxr.h"

static int	ft_tokens_error(void *ptr)
{
	t_tkn	*tokens;
...
static int	ft_tokens_ambiguous(void *ptr)
{
	t_tkn	*tokens;
...
static int	ft_tokens_syntax_error(void *ptr)
{
	t_tkn	*tokens;
